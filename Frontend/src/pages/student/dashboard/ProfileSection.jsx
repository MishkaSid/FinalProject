...
const ProfileSection = ({ 
  ...
  return (
    <div className={styles.heroProfile}>
      ...
      <div style={{
        background: hasValidData ? 'rgba(40,167,69,0.2)' : 'rgba(255,193,7,0.2)',
        border: `1px solid ${hasValidData ? 'rgba(40,167,69,0.3)' : 'rgba(255,193,7,0.3)'}`,
        borderRadius: '5px',
        padding: '5px',
        margin: '5px',
        textAlign: 'center'
      ...
      {refreshing && (
        <div style={{background: 'rgba(255,255,255,0.2)', padding: '8px', margin: '5px', borderRadius: '5px', textAlign: 'center'}}>
          <div className={styles.miniSpinner} style={{margin: '0 auto'}}></div>
          <span style={{color: 'white', fontSize: '12px', display: 'block', marginTop: '5px'}}>
            מרענן נתונים מהשרת...
          </span>
        </div>
      )}
      ...
      {error && (
        <div style={{background: 'rgba(255,0,0,0.2)', padding: '8px', margin: '5px', borderRadius: '5px', textAlign: 'center', border: '1px solid rgba(255,0,0,0.3)'}}>
          <span style={{color: 'white', fontSize: '12px', display: 'block', marginBottom: '5px'}}>
          ...
          <button 
            ...
            onMouseOver={(e) => e.target.style.background = 'rgba(0,123,255,0.3)'}
            onMouseOut={(e) => e.target.style.background = 'rgba(0,123,255,0.2)'}
          >
